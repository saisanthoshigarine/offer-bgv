...
def send_async(to, subject, html, attach_path=None, attach_name=None, user_id=None, candidate_id=None, email_type='offer'):
    # Vercel serverless: threads are killed on response — send synchronously
    return send_email(to, subject, html, attach_path, attach_name, user_id, candidate_id, email_type)
